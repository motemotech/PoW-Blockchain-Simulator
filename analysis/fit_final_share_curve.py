...
DATA_DIR_OVERRIDE: Optional[str] = "data/compare-eth-alpha-0.5-1000"
...
def create_individual_comparison_plot(variable_name: str, Delta_sorted: np.ndarray, T_fixed: float, 
    ...
    """Create individual comparison plot without difference subplot."""
    ...
    ax.plot(x_smooth, theory_smooth, color="crimson", lw=2.5, label=f"Theory (α={alpha_fixed})")
